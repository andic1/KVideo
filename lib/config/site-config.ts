...
export const siteConfig: SiteConfig = {
  title: process.env.NEXT_PUBLIC_SITE_TITLE || "名誉寒冰 - 专用影视库",
  description: process.env.NEXT_PUBLIC_SITE_DESCRIPTION || "专用影视库",
  name: process.env.NEXT_PUBLIC_SITE_NAME || "名誉寒冰",
};